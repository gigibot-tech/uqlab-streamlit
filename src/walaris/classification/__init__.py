...
Modules:
    ...
    - feature_extractor: Model-agnostic feature extraction (NEW - Phase 7.2)
...
New Features (Optional):
    ...
    - Model-agnostic feature extraction (see feature_extractor.py)
    - Unit tests with pytest (see tests/)
    - Type checking with mypy (see mypy.ini)
    - See IMPROVEMENTS_GUIDE.md for details
"""

__version__ = "2.3.0"  # Bumped for Phase 7.2 - Feature Extractor
...
__all__ = [
    ...
    "train_feature_model",
    "EmbeddingOrganizer",
    # Feature extraction (NEW - Phase 7.2)
    "FeatureExtractor",
    "DINOv2FeatureExtractor",
    "CNNFeatureExtractor",
    "ResNetFeatureExtractor",
