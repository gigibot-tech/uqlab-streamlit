...
_LAZY = {
    ...
    "normalize_architecture": ("architecture", "normalize_architecture"),
    "normalize_dinov2_model": ("architecture", "normalize_dinov2_model"),
    "scope_to_training_mode": ("architecture", "scope_to_training_mode"),
    "validate_training_scope": ("training_scope", "validate_training_scope"),
    "resolve_training_scope": ("training_scope", "resolve_training_scope"),
