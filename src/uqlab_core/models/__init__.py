...
_LAZY = {
    ...
    "normalize_architecture": ("factory.architecture", "normalize_architecture"),
    "normalize_dinov2_model": ("factory.architecture", "normalize_dinov2_model"),
    "scope_to_training_mode": ("factory.architecture", "scope_to_training_mode"),
    "validate_training_scope": ("factory.training_scope", "validate_training_scope"),
    "resolve_training_scope": ("factory.training_scope", "resolve_training_scope"),
