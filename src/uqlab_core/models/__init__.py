...
_LAZY = {
    ...
    "normalize_architecture": ("scope", "normalize_architecture"),
    "normalize_dinov2_model": ("scope", "normalize_dinov2_model"),
    "scope_to_training_mode": ("scope", "scope_to_training_mode"),
    "validate_training_scope": ("scope", "validate_training_scope"),
    "resolve_training_scope": ("scope", "resolve_training_scope"),
