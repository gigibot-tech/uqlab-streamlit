...
Runnable experiment configs bundled with `uqlab_core` for CLI, notebooks, and validation scripts.
...
│   ├── default.yaml
│   ├── fast_pilot.yaml
│   └── four_region.yaml   ← CLI default (scripts/runners/run_fast_uncertainty_classification.py)
├── test/                # Architecture smoke configs (scripts/setup/validate_architectures.py)
