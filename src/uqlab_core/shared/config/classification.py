...
def normalize_dinov2_model(model_name: str) -> str:
    ...
    from uqlab_core.models.scope import normalize_dinov2_model as _normalize
...
class ModelConfig(BaseModel):
    ...
    def sync_scope_and_mode(self) -> "ModelConfig":
        from uqlab_core.models.scope import normalize_architecture, scope_to_training_mode
