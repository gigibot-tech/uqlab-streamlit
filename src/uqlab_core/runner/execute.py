...
from uqlab_core.shared.config.scope.architecture import normalize_architecture, scope_to_training_mode
from uqlab_core.shared.config.scope.training_scope import validate_training_scope
...
def validate_model_scope_after_build(model, *, architecture: str, training_scope: str):
    ...
    from uqlab_core.shared.config.scope.training_scope import resolve_training_scope
