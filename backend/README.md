...
Start the local development environment with Docker Compose following the guide in [../docs/development/backend-development.md](../docs/development/backend-development.md).
