...
Start the local development environment with Docker Compose following the guide in [../docs/development/DEVELOPMENT_ENVIRONMENT.md](../docs/development/DEVELOPMENT_ENVIRONMENT.md).
