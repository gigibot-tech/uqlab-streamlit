...
Start the local development environment with Docker Compose following the guide in [../docs/development/development-environment.md](../docs/development/development-environment.md).
