...
| **Python script** | `run_server.py` | `run_server.py --prod` |
...
### Development Mode (`run_server.py`)
```python
uvicorn.run(
    "app.main:app",
    host="0.0.0.0",
...
### Production Mode (`run_server.py --prod`)
```python
uvicorn.run(
    "app.main:app",
    host="0.0.0.0",
