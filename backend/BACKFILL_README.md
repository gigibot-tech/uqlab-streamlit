...
The `scripts/backfill_signals.py` script reads the `summary.json` files from your results directory and populates the `best_signals_json` column in the database.
