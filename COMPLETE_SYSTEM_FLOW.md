...
> **📖 Architecture Questions?** See [`docs/archive/ARCHITECTURE_CLARIFICATION.md`](docs/archive/ARCHITECTURE_CLARIFICATION.md) for package boundaries and responsibilities.
