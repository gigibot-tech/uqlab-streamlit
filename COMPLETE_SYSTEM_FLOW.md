...
> **📖 Architecture Questions?** See [`docs/architecture/ARCHITECTURE_CLARIFICATION.md`](docs/architecture/ARCHITECTURE_CLARIFICATION.md) for package boundaries and responsibilities.
