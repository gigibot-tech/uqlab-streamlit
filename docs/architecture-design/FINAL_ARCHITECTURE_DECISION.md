...
> **Superseded (2026-06):** Entry point is now `uqlab.runner.execute.run_from_yaml`; core is `runner/experiment_core.py`. See [`../architecture/PACKAGE_REDESIGN.md`](../architecture/PACKAGE_REDESIGN.md).
