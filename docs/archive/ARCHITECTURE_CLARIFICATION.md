...
See also [`../architecture/evaluation-pipeline.md`](../architecture/evaluation-pipeline.md) for the evaluation phase breakdown.
...
| [`../architecture/evaluation-pipeline.md`](../architecture/evaluation-pipeline.md) | Evaluation pipeline structure |
| [`STEP3_FLOW_ANALYSIS.md`](STEP3_FLOW_ANALYSIS.md) | Historical UI → runner notes |
