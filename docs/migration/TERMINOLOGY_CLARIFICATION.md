...
> **Superseded (2026-06):** Module names below predate `runner/execute.py`, `runner/experiment_core.py`, and the evaluation package split. See [`docs/architecture/PACKAGE_REDESIGN.md`](../architecture/PACKAGE_REDESIGN.md) and [`START_HERE.md`](../setup/START_HERE.md).
