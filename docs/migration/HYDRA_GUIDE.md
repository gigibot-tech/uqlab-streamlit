...
@hydra.main(version_base=None, config_path="src/uqlab_core/configs", config_name="experiment/default")
...
@hydra.main(
    version_base=None,
    config_path="src/uqlab_core/configs",  # Relative to script location
