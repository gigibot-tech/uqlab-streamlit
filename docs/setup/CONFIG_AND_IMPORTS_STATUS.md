...
```
uqlab-streamlit/
├── src/uqlab_core/configs/     # ✅ YAML configs (shipped with package)
├── src/
...
- **YAML files** in [`src/uqlab_core/configs/`](src/uqlab_core/configs:1) - Used by runners and scripts
...
- **Long term**: Migrate to Python configs in `src/uqlab_core/shared/config/classification.py`
