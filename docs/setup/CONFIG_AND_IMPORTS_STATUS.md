...
**Status**: ✅ **Still valid and used by runner scripts**
...
```
uqlab-streamlit/
├── src/uqlab_core/configs/   # ✅ YAML configs (still used)
│   ├── experiment/
│   └── test/
├── src/
...
- **YAML files** in [`src/uqlab_core/configs/`](src/uqlab_core/configs:1) - Used by runner scripts
