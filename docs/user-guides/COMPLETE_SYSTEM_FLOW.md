...
> **📖 Architecture Questions?** See [`../architecture/ARCHITECTURE_CLARIFICATION.md`](../architecture/ARCHITECTURE_CLARIFICATION.md) for package boundaries and responsibilities.
