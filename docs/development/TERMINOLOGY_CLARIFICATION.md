...
> **Superseded (2026-06):** Module names below predate `runner/execute.py`, `runner/experiment_core.py`, and the evaluation package split. See [`../architecture/PACKAGE_REDESIGN.md`](../architecture/PACKAGE_REDESIGN.md) and [`../../START_HERE.md`](../../START_HERE.md).
...
**Proposed fix**: Move `scripts/runners/` → `src/uqlab/cli/` (see [`../architecture-design/FINAL_ARCHITECTURE_DECISION.md`](../architecture-design/FINAL_ARCHITECTURE_DECISION.md))
