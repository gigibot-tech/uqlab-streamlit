...
✅ **Completed** — `configs/` has been relocated to `src/uqlab_core/configs/` on branch `cursor/small-file-relocation-candidates-6938`. The runtime path helper, package metadata, code references, notebooks, scripts, and documentation have been updated to use the new location.
