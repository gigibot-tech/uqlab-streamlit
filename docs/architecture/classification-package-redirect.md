...
| `evaluation.classification.models` | `uqlab.models.factory.classification_models` |
...
| `evaluation.classification.image_dataset` | `uqlab.data.datasets.image` |
| `evaluation.classification.benchmark_axes` | `uqlab.data.splits.benchmark_axes` |
...
See [docs/setup/IMPORT_GUIDE.md](../../../docs/setup/IMPORT_GUIDE.md) for the full map.
