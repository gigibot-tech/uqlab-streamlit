...
### 5. Startup Script ✅
**File**: `scripts/deployment/start_with_minio.sh` (executable)
...
```bash
cd uqlab-streamlit
./scripts/deployment/start_with_minio.sh
```
...
- [ ] Test script: `./scripts/deployment/start_with_minio.sh` should start both services

## Files Created/Modified

### Created
1. `docker-compose.yml` - MinIO service configuration
2. `scripts/deployment/start_with_minio.sh` - Convenience startup script
