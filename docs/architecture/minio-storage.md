...
### 5. Startup Script ✅
**File**: `scripts/start-with-minio.sh` (executable)
...
- [ ] Test script: `./scripts/start-with-minio.sh` should start both services

## Files Created/Modified

### Created
1. `docker-compose.yml` - MinIO service configuration
2. `scripts/start-with-minio.sh` - Convenience startup script
