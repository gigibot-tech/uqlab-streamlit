...
### 🔍 [Archived Troubleshooting](./archive/troubleshooting/)
Historical bug fixes, issues, and debugging guides that have been archived:
...
**Machine Learning**
- [ResNet Feature Extractor Fix (archived)](./archive/troubleshooting/resnet-feature-extractor.md)
- [Sweep Grouping](./features/sweep-grouping.md)

**UI & Frontend**
- [Progressive UI Fixes (archived)](./archive/troubleshooting/progressive-ui.md)
- [Startup Issues (archived)](./archive/troubleshooting/startup-issues.md)
...
1. [Startup Issues (archived)](./archive/troubleshooting/startup-issues.md)
2. [Progressive UI Fixes (archived)](./archive/troubleshooting/progressive-ui.md)
3. [Sweep Grouping](./features/sweep-grouping.md)
4. [ResNet Feature Extractor Fix (archived)](./archive/troubleshooting/resnet-feature-extractor.md)
...
1. **Choose the right category**:
   ...
   - `archive/troubleshooting/` - Archived bug fixes and issues
   - `api/` - API reference
...
1. Check the [Archived Troubleshooting](./archive/troubleshooting/) section
