...
1. `configs/examples/example_cnn_mcdropout.yaml` - CNN MC Dropout configuration
2. `configs/examples/example_resnet18_mcdropout.yaml` - ResNet18 MC Dropout configuration
...
### Files Created
- `uqlab-streamlit/configs/examples/example_cnn_mcdropout.yaml`: Example CNN config
- `uqlab-streamlit/configs/examples/example_resnet18_mcdropout.yaml`: Example ResNet18 config
