...
1. `src/uqlab_core/configs/example_cnn_mcdropout.yaml` - CNN MC Dropout configuration
2. `src/uqlab_core/configs/example_resnet18_mcdropout.yaml` - ResNet18 MC Dropout configuration
...
### Files Created
- `src/uqlab_core/configs/example_cnn_mcdropout.yaml`: Example CNN config
- `src/uqlab_core/configs/example_resnet18_mcdropout.yaml`: Example ResNet18 config
