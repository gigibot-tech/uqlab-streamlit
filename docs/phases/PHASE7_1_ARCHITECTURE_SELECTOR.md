...
1. `configs/experiment/examples/example_cnn_mcdropout.yaml` - CNN MC Dropout configuration
2. `configs/experiment/examples/example_resnet18_mcdropout.yaml` - ResNet18 MC Dropout configuration
...
### Files Created
- `uqlab-streamlit/configs/experiment/examples/example_cnn_mcdropout.yaml`: Example CNN config
- `uqlab-streamlit/configs/experiment/examples/example_resnet18_mcdropout.yaml`: Example ResNet18 config
