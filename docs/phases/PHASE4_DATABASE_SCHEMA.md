...
#### Python Migration Runner (`backend/migrations/run_add_benchmark_tables.py`)
...
```bash
cd uqlab-streamlit
python3 backend/migrations/run_add_benchmark_tables.py
```
...
2. **`backend/migrations/run_add_benchmark_tables.py`** (67 lines)
