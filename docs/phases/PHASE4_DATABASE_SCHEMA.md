...
#### Python Migration Runner (`scripts/migrations/add_benchmark_tables.py`)
...
```bash
cd uqlab-streamlit
python3 scripts/migrations/add_benchmark_tables.py
```
...
2. **`scripts/migrations/add_benchmark_tables.py`** (~63 lines)
