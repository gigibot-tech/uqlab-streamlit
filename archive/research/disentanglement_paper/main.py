...
def main() -> None:
    ...
    from uqlab.disentanglement_paper.benchmarks.decreasing_dataset import (
        plot_decreasing_dataset,
    )
    from uqlab.disentanglement_paper.benchmarks.label_noise import label_noise
    from uqlab.disentanglement_paper.benchmarks.ood_class_detection import (
        plot_ood_class_detection,
    )
    from uqlab.disentanglement_paper.experiment_configs import get_experiment_configs
    from uqlab.disentanglement_paper.settings import GPU_INDEX, TEST_MODE
