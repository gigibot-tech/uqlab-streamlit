...
Full flow diagram and FAQ: [`EXECUTION_FLOW_AND_CONFIG_GUIDE.md`](docs/user-guides/EXECUTION_FLOW_AND_CONFIG_GUIDE.md).  
...
See `docs/user-guides/START_HERE.md` for the full run flow. The legacy `streamlit_app.py` is deprecated and archived under `dead_code/`.
