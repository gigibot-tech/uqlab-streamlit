...
├── src/uqlab_core/configs/       # Experiment configurations (canonical; `configs/` symlink for compat)
...
- `src/uqlab_core/configs/`: Experiment YAML configurations (`configs/` symlink for backward compatibility)
