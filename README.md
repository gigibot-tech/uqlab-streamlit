...
Full flow diagram and FAQ: [`docs/architecture/EXECUTION_FLOW_AND_CONFIG_GUIDE.md`](docs/architecture/EXECUTION_FLOW_AND_CONFIG_GUIDE.md).  
...
See [`docs/START_HERE.md`](docs/START_HERE.md) for the full run flow. The legacy `streamlit_app.py` is deprecated and archived under `dead_code/`.
