...
│   └── uqlab_core/               # ML core package (data, train, eval)
│       └── configs/              # Experiment YAML configurations (shipped with the package)
...
- `src/uqlab_core/configs/`: Experiment YAML configurations (shipped with the installed package)
