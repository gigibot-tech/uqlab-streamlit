...
├── src/configs/                  # Experiment configurations (canonical; root configs/ is a symlink)
...
- `src/configs/`: Experiment YAML configurations (root `configs/` is a backward-compatible symlink)
