...
├── src/uqlab_core/configs/       # Experiment configurations (canonical)
...
- `src/uqlab_core/configs/`: Experiment YAML configurations (root `configs/` is a backward-compatible symlink)
