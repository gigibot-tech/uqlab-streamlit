...
├── src/uqlab_core/configs/       # Experiment configurations (bundled with core package)
...
- `src/uqlab_core/configs/`: Experiment YAML configurations (shipped with the `uqlab_core` package)
