...
> **Looking to deploy?** See the [Deployment Guide](../docs/internal/oc-deployment.md) for quickstart instructions.
...
See the [Deployment Guide](../docs/internal/oc-deployment.md#4-create-github-token-recommended) for step-by-step instructions on creating a GitHub Personal Access Token.
