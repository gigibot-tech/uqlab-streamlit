...
> **Looking to deploy?** See the [Deployment Guide](../docs/deployment/openshift.md) for quickstart instructions.
...
See the [Deployment Guide](../docs/deployment/openshift.md#4-create-github-token-recommended) for step-by-step instructions on creating a GitHub Personal Access Token.
