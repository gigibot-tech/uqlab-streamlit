...
def update_imports(file_path: Path) -> tuple[bool, int]:
    ...
    new_content, n = re.subn(r"from uq_classification\.(\w+)", r"from uqlab.evaluation.classification.\1", content)
    content = new_content
    replacements += n
    ...
    new_content, n = re.subn(r"from uq_classification import", r"from uqlab.evaluation.classification import", content)
    content = new_content
    replacements += n
